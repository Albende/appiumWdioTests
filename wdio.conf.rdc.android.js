exports.config = {
    ...
    //
    user: process.env.SAUCE_USERNAME_SUPPORT,
    key: process.env.SAUCE_ACCESS_KEY_SUPPORT,
    //
    ...
    //
    specs: [
        './test/specs/addThreeItemsAndroid.js'
    ],
    // Patterns to exclude.
    exclude: [
    ...
    capabilities: [
        {
            ...
            deviceName: 'Google_Pixel_4_XL_real',
            ...
            name: 'Android addig items to the cart',
    ...
    baseUrl: 'https://docs.saucelabs.com/',
    //
